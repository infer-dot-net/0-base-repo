...
namespace Models
{
	...
	/// 
	/// Generated by Infer.NET 0.3.1912.403 at 9:41 AM on Wednesday, February 3, 2021.
	/// </remarks>
	public partial class Model0_Gibbs : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_firstCoin_numberOfIterations has executed. Set this to false to force re-execution of Changed_firstCoin_numberOfIterations</summary>
		public bool Changed_firstCoin_numberOfIterations_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_Init_firstCoin has executed. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_Init_firstCoin</summary>
		public bool Changed_numberOfIterationsDecreased_Init_firstCoin_isDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_Init_firstCoin has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_Init_firstCoin</summary>
		public bool Changed_numberOfIterationsDecreased_Init_firstCoin_isInitialised;
		...
		public bool firstCoin
		{
			...
			set {
				if (this.FirstCoin!=value) {
					...
					this.Changed_numberOfIterationsDecreased_Init_firstCoin_isInitialised = false;
					this.Changed_firstCoin_numberOfIterations_isDone = false;
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			if (numberOfIterations!=this.numberOfIterationsDone) {
				if (numberOfIterations<this.numberOfIterationsDone) {
					this.numberOfIterationsDone = 0;
					this.Changed_numberOfIterationsDecreased_Init_firstCoin_isDone = false;
				}
				this.Changed_firstCoin_numberOfIterations_isDone = false;
			}
			this.Constant();
			this.Changed_numberOfIterationsDecreased_Init_firstCoin(initialise);
			this.Changed_firstCoin_numberOfIterations(numberOfIterations);
